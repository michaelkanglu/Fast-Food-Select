...
public class SelectionList extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setListAdapter(new ArrayAdapter<FoodItem>(this,
	...
	private class ModeCallback implements ListView.MultiChoiceModeListener {
		...
		public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
			...
			case R.id.share:
				...
				break;
			default:
				Toast.makeText(SelectionList.this,
	...
	public void setMenuList(List<FoodItem> list) {
		mStrings = (FoodItem[]) list.toArray();
	}

	private FoodItem[] mStrings;
}
